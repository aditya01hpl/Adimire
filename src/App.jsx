...
import ExperiencePage from './ExperiencePage';  // Add this import
...
const App = () => {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const experienceSection = document.getElementById('experience-section');  // Add this
      const articlesSection = document.getElementById('articles-section');
      
      if (heroSection && aboutSection && projectsSection && experienceSection && articlesSection) {
        ...
        const experienceTop = experienceSection.getBoundingClientRect().top;  // Add this
        const experienceBottom = experienceSection.getBoundingClientRect().bottom;  // Add this
        ...
        if (articlesTop <= window.innerHeight / 2 && articlesBottom > window.innerHeight / 2) {
          ...
          setActiveSection('experience');  // Add this
