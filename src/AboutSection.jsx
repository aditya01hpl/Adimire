...
const AboutSection = () => {
  return (
    ...
    <div className="h-screen bg-[#0F0F0F] text-white flex items-center px-8">
      ...
      <div className="max-w-7xl mx-auto w-full flex items-start gap-12">
        ...
        <div className="flex-1">
          ...
          <h2 
            className="text-5xl font-black leading-tight mb-8 text-[#F5F5F5]" 
          ...
          <div>
            ...
            */}
            ...
            <p 
              className="text-base leading-relaxed text-[#F5F5F5]"
              style={{ fontFamily: 'DM Sans, sans-serif' }}
            >
          ...
          <button 
            className="mt-10 px-8 py-3 border-2 border-[#0066FF] text-[#0066FF] rounded-full text-xs font-bold tracking-wider hover:bg-[#0066FF] hover:text-white transition-all duration-300 clear-both" 
            style={{ fontFamily: 'DM Sans, sans-serif' }}
          >
            MORE ABOUT ME
          </button>
